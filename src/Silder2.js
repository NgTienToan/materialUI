...
export default function Silder2() {
  ...
  return (
    <Grid container={false} className={classes.root}>
      <Grid item xs={12} sm={7} lg={7} className={classes.group1}>
      ...
      <Grid item className={classes.group2} xs={11} sm={12}>
      ...
      <Grid item className={classes.group3} xs={11} sm={12}>
      ...
      <Grid item className={classes.group4} xs={10} sm={9}>
